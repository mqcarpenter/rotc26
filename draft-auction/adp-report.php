    ...
    <?php else: ?>
      <div class="card">
        ...
        <table class="data-table">
          <thead><tr><th>Rank</th><th></th><th>Player</th><th>Pos</th><th>Team</th><th>Avg Pick</th><th>Min</th><th>Max</th><th>Draft %</th></tr></thead>
          <tbody>
            ...
            <?php endforeach; ?>
            <?php if (!$rows): ?>
              <tr><td colspan="9">No ADP data available.</td></tr>
            <?php endif; ?>
          </tbody>
        </table>
        </div>
